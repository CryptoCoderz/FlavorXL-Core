...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangeFlavorXLersed READ rangeFlavorXLersed WRITE setRangeFlavorXLersed)
...
public:
  ...
  */
  ...
  bool rangeFlavorXLersed() const { return mRangeFlavorXLersed; }
  ...
  void setRangeFlavorXLersed(bool reversed);
