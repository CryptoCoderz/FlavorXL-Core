...
/** FlavorXL unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FlavorXLUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FlavorXLUnits(QObject *parent);
...
typedef FlavorXLUnits::Unit FlavorXLUnit;
