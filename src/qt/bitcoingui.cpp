 ...
 * The FlavorXL Developers 2018-2020
 */
...
FlavorXLGUI::FlavorXLGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("FlavorXL") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("FlavorXL");
    setStyleSheet("#FlavorXL { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
void FlavorXLGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FlavorXL address"));
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About FlavorXL"), this);
    aboutAction->setToolTip(tr("Show information about FlavorXL"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for FlavorXL"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit FlavorXL.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for FlavorXL"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit FlavorXL.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for FlavorXL (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where FlavorXL data is stored"));
...
//void FlavorXLGUI::createMenuBar()
//{
//#ifdef Q_OS_MAC
...
void FlavorXLGUI::createToolBars()
{
...
void FlavorXLGUI::setClientModel(ClientModel *clientModel)
{
    netLabel->setText("v1.0.0.7");// Version in GUI
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("FlavorXL client") + QString(" ") + tr("[testnet]"));
...
void FlavorXLGUI::setWalletModel(WalletModel *walletModel)
{
...
void FlavorXLGUI::setMessageModel(MessageModel *messageModel)
{
...
void FlavorXLGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
    ...
    trayIcon->setToolTip(tr("FlavorXL client"));
...
#ifndef Q_OS_MAC
void FlavorXLGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void FlavorXLGUI::optionsClicked()
{
...
void FlavorXLGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void FlavorXLGUI::aboutQtExt_Static()
{
    guiref->aboutQtExt_Internal();
}

void FlavorXLGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    //labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FlavorXL network", "", count));
}

void FlavorXLGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void FlavorXLGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("FlavorXL") + " - ";
...
void FlavorXLGUI::error(const QString &title, const QString &message, bool modal)
{
...
void FlavorXLGUI::changeEvent(QEvent *e)
{
...
void FlavorXLGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void FlavorXLGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(FlavorXLUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void FlavorXLGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(FlavorXLUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void FlavorXLGUI::incomingMessage(const QModelIndex & parent, int start, int end)
{
    if(!messageModel)
        return;
...
void FlavorXLGUI::gotoMasternodeManagerPage()
{
    ...
    setStyleSheet("#FlavorXL { background-image: url(:/images/background_light_alt); }");
}

void FlavorXLGUI::gotoBlockBrowser()
{
...
void FlavorXLGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#FlavorXL { background-image: url(:/images/background_light); }");
}

void FlavorXLGUI::gotoHistoryPage()
{
...
void FlavorXLGUI::gotoHistoryPage_static()
{
    guiref->gotoHistoryPage();
}

void FlavorXLGUI::gotoAddressBookPage()
{
...
void FlavorXLGUI::gotoReceiveCoinsPage()
{
...
void FlavorXLGUI::gotoSendCoinsPage()
{
...
void FlavorXLGUI::gotoSignMessageTab(QString addr)
{
...
void FlavorXLGUI::gotoVerifyMessageTab(QString addr)
{
...
void FlavorXLGUI::gotoMessagePage()
{
...
void FlavorXLGUI::gotoSettingsPage()
{
...
void FlavorXLGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void FlavorXLGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid FlavorXL address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void FlavorXLGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void FlavorXLGUI::setWalletUnlockStakingOnly()
{
...
void FlavorXLGUI::setUnencrypted()
{
    changePassphraseAction->setEnabled(false);
...
void FlavorXLGUI::setEncryptionStatus(int status)
{
...
void FlavorXLGUI::encryptWallet()
{
    if(!walletModel)
        return;
...
void FlavorXLGUI::importPrivateKey()
{
...
void FlavorXLGUI::changePassphrase()
{
...
void FlavorXLGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void FlavorXLGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void FlavorXLGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
/*void FlavorXLGUI::updateStakingIcon()
{
    updateWeight();
...
void FlavorXLGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

/*void FlavorXLGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
...
void FlavorXLGUI::editConfigExt()
{
