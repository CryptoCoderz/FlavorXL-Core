...
/**
  FlavorXL GUI main class. This class represents the main window of the FlavorXL UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FlavorXLGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit FlavorXLGUI(QWidget *parent = 0);
    ~FlavorXLGUI();
    ...
    */
    ...
    /** Set the message model.
        The message model represents a FlavorXL  Note or D-Note, and offers secure messaging through a peer to peer
        relay.
    */
