...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so FlavorXLUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(FlavorXLUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(FlavorXLUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(FlavorXLUnits::formatWithUnit(nDisplayUnit, amount, true, FlavorXLUnits::separatorAlways));
