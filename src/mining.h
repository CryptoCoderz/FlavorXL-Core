...
static const int64_t nBlockRewardReserve = 1000000 * COIN; // premine 100,000,000 FXL
...
inline int64_t MasternodeCollateral(int nHeight) { return 90000; } // 90 thousand FXL required as collateral
