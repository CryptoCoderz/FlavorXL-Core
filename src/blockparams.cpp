...
// Copyright (c) 2020 The FlavorXL project
...
//
//
// Reward calculations for 380-years of FXL emissions
// 21 Million Total     | 100,000,000 Premine (For Swap)
// 100% Remaining FXL :  100,000,000 (Mineable)
// ----------------------------------
...
// Payout per block     : 5 FXL
// Payout per day       : 5 * ((1 * 60 * 60) / (5 * 60) * 24)                   =       1,440 FXL
// Payout per month     : 5 * (((1 * 60 * 60) / (5 * 60) * 24) * 30)            =      43,200 FXL
// Payout per year      : 5 * (((1 * 60 * 60) / (5 * 60) * 24) * 365)           =     525,600 FXL
// Mineout (380 Years)   : 5 * (380.6 * (((1 * 60 * 60) / (5 * 60) * 24) * 365))=  200,000,000 FXL
// ----------------------------------
// (Network Allocation) (BLOCKS | 380-Years of minting)
// Singular Payout      : 1.25 FXL
// Maternode Payout     : 3.50 FXL
// DevOps Payout        : 0.25 FXL
// Total Payout (Block) : 5.00 FXL
// ----------------------------------
// (PLEASE NOTE)
